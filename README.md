...
is shown as a circle arranged on a cross. The size of each circle represents the number of cases per region and the color
shows the regional prevalence (percent of adults 65+ with Alzheimer's). The tooltip appears on hover and shows the top states
